	...
	<form action="nedmin/netting/islem.php" method="POST" class="form-horizontal checkout" role="form">
      ...
      <?php } elseif (@$_GET['durum']=="basarisiz") {?>
				...
				<div class="form-group dob">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" name="kullanici_ilce"  placeholder="ilçe"   value="<?php echo $kullanicicek['kullanici_ilce'] ?>">
					</div>
				</div>
			...
			<div class="col-md-6">
				...
				<center><a href="sifre-guncelle"><img width="400" ></a></center>
			</div>
		</div>
	</div>
</form>
