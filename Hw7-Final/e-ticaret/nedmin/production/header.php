<?php
ob_start();
session_start();//sesion nu burda kullanacağız.
include '../netting/baglan.php';

//Belirli veriyi seçme işlemi
$ayarsor=$db->prepare("SELECT * FROM setting where ayar_id=:id");
...
$kullanicisor->execute(array(
  'mail' => $_SESSION['kullanici_mail'] //sisteme girmiş kullanıcıya ait bilgi
  ));
$say=$kullanicisor->rowCount();//sistemde kullanıcı var mı yok mu
$kullanicicek=$kullanicisor->fetch(PDO::FETCH_ASSOC);

if ($say==0) {

  Header("Location:login.php?durum=izinsiz");
  exit;// bu zorunda yoksa olmaz.
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                <span>Welcome,</span>
                <h2><?php echo  $kullanicicek['kullanici_adsoyad'];?></h2><!--kullanıcın ismini yazdırmak istiyorum-->
              </div>
            </div>
            <!-- /menu profile quick info -->
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <!--Javascript void tıkladığımda bana geri bildirimde bulunmaz.-->
                  ...
                  <li><a href="slider.php"><i class="fa fa-image"></i>Slider</a></li><!-- ikonu belirleme-->
