    ...
    <div class="row">
      ...
      <div class="col-md-4"><!--footer contact widget-->
        ...
        <ul class="contact-widget">
          <li class="fphone"><?php echo $ayarcek['ayar_phone']; ?> <br><?php echo $ayarcek['ayar_fax']; ?></li>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-9">
        ...
        <div class="f-credit">&copy;<?php echo $ayarcek['ayar_author'];?> <a href="#">SumeyraDesign.com</a></div>
