...
// Bu sepete ekleme işlemi başaramadım sonra denemelik
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-6 col-md-4 main-logo">
					<a href="index.php"><img width= "130" src="<?php echo $ayarcek['ayar_logo']; ?>" alt="Site logosu" class="logo img-responsive"></a>
				</div>
...
<div class="btn-popcart">
 <a href="sepet" class="btn btn-default btn-red btn-sm">Sepeti Görüntele</a>
</div>
