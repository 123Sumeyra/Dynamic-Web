...
<head>
	...
	<!-- fancy Style  bu resmin çarpı işareti için hatırla-->
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="dt-img">
						...
						<a class="fancybox" href="<?php echo $urunfotocek['urunfoto_resimyol'] ?>" data-fancybox-group="gallery"
							 title="Cras neque mi, semper leon"><img src="<?php echo $urunfotocek['urunfoto_resimyol'] ?>" alt="" class="img-responsive"></a>
					</div>
					...
					<div class="thumb-img">
						<a class="fancybox" href="<?php echo $urunfotocek['urunfoto_resimyol'] ?>" data-fancybox-group="gallery"
							 title="Cras neque mi, semper leon"><img src="<?php echo $urunfotocek['urunfoto_resimyol'] ?>" alt=""
					...
					<div class="productdata">
						...
						<form action="nedmin/netting/islem.php" method="POST">
							...
							<div class="form-group">
									...
									<div class="col-sm-4">
										<button type="submit" name="sepetekle" class="btn btn-default btn-red btn-sm"><span class
											="addchart">Sepete Ekle</span></button>
									</div>
									<div class="clearfix"></div>
								</div>
						</form>
